...
function Books() {
  ...
  const category = categories.find(
    (category) => category.name === categoryName?.replace(/-/g, " "),
  );
    ...
    const categoryMatch =
      ...
      selectedCategories.some((selectedCategory) =>
        book.categories.some(
          (bookCategory) => bookCategory.id === selectedCategory.id,
        ),
      );
    const priceMatch =
      selectedPrice === null ||
      ...
      (selectedPrice === "over-30" && book.price >= 30);
    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      <div className="grid md:grid-cols-[240px_1fr] gap-8">
        <div className="bg-background p-6 rounded-lg shadow">
          ...
          <Accordion type="multiple" className="min-h-[440px]">
